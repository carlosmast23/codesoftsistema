...
<!--[if lte IE 6]></td></tr></table></a><![endif]-->
  ...
  <tr>
    <td>
              <div align="center">
              <img src="img/recursos/academico.png" width="129" height="176" />
              </div></td>
    <td><p>Ofrecemos servicios académicos con profesionales politécnicos calificados en las siguientes Áreas:
            </p>
             <table width="200" border="0">
  <tr>
    <td>- Deberes dirigidos</td>
  </tr>
  <tr>
    <td>- Guías</td>
  </tr>
...
<h3>Materias de las ciencias de la computación </h3>
<ol>
<li>-Java</li>
	<li>-C++</li>
	<li>-Visual Basic</li>
...
<p>Si el área académica que busca no se encuentra en la lista, se puede contactar con el encargado de dicha area para obtener mayor información.  <a href="contactos.php">Contactos</a></p>
