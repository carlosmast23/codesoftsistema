...
<!--[if lte IE 6]></td></tr></table></a><![endif]-->
      ...
      <!-- TemplateBeginEditable name="Slider" -->Slider<!-- TemplateEndEditable -->
      
      <div class="hojaTrabajo">
      		<div class="contenido"><!-- TemplateBeginEditable name="Contenido" -->
      		  Aqui va el menu
      		<!-- TemplateEndEditable -->
        ...
        <!-- TemplateBeginEditable name="otroContenido" --> otro contenido
		<!-- TemplateEndEditable -->
