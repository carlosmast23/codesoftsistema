...
<script src="qr/jquery-1.6.2.min.js" type="text/javascript"></script>
		<script language="JavaScript">
				function qrdata(data) 
				{
					...
					//document.writeln(cod);
					//var elem = cod.split(',');
					document.getElementById('usuario').value=cod;
					//document.getElementById('clave').value=elem[1];
...
<!--[if lte IE 6]></td></tr></table></a><![endif]-->
    ...
    <table width="200" border="0">
      <tr>
             ...
             <div align="center"><h2>Iniciar Sesion</h2></div>
            </td>
         ...
         <tr>
	  	...
	  	<div id="flashContent" style="float:right">
			<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="350" height="350" id="qrcode" align="right">
				<param name="movie" value="qrcode.swf" />
				...
				<param name="FlashVars" value="stagesize=400&spritegradienta=0xCCCCCC&spritegradientb=0x999999" />
				<!--[if !IE]>-->
			  <object type="application/x-shockwave-flash" data="qr/qrcode.swf" width="350" height="350">
					<param name="movie" value="qrcode.swf" />
					<param name="FlashVars" value="stagesize=400&spritegradienta=0xCCCCCC&spritegradientb=0x999999" />
					<param name="quality" value="high" />
					<param name="bgcolor" value="#ffffff" />
